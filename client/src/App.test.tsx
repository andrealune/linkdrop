...
describe('App', () => {
  beforeEach(() => {
    // Avoid a real network call to the API during this smoke test.
    vi.stubGlobal(
      'fetch',
  ...
  it('renders the app title and configured API URL', async () => {
    ...
    // Let the health-check effect settle so React doesn't warn about an
    // update happening after the test has finished asserting.
